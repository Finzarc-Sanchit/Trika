...
import { Sparkles, Activity, Heart, Music, Target, Users } from 'lucide-react';
        ...
        <section className="py-24 bg-white px-6 md:px-12 max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                ...
                <div>
                    ...
                    <h2 className="font-serif text-4xl md:text-5xl text-[#1c1917] mb-12">What Makes Trika Unique</h2>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        {uniqueFeatures.map((feature, index) => {
                            ...
                            return (
                                ...
                                >
                                    <IconComponent className="w-8 h-8 text-[#A69C8E] mb-3" />
                                    <h3 className="font-serif text-lg font-semibold text-[#1c1917] mb-2">{feature.title}</h3>
